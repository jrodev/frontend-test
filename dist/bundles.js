...
(0, _jquery2.default)(function () {
    ...
    var $inputNumber = (0, _jquery2.default)("#inputNumber"),
        $buttonAdd = (0, _jquery2.default)("#buttonAdd"),
        $listItems = (0, _jquery2.default)("#listItems"),
        $buttonSort = (0, _jquery2.default)("#buttonSort"),
        $formAdd = (0, _jquery2.default)('#formAdd');

    // Verificando que se escribio un numero para ingresar
    $inputNumber.on('keyup', function () {
        var sThisVal = _jquery2.default.trim((0, _jquery2.default)(this).val()),
    ...
    $formAdd.on('submit', function (e) {
        ...
        var sNumVal = _jquery2.default.trim($inputNumber.val()),
    ...
    $buttonSort.on('click', function () {
        var aList = (0, _jquery2.default)(this).data('arrList') // Lista hasta el momento
        ,
